 ...
 */
final class Version20190728214530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP adresse, CHANGE depot_id partenaire_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD adresse VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE partenaire_id depot_id INT DEFAULT NULL');
